...
class Test(TestCase):
    ...
    def test_evaluate_lared_larem(self):
        ...
        self.assertAlmostEqual(
            results.loc[f"{ood_ds_name} LaRED"]["auroc"], 0.9425060153007507, delta=TOL
        )
        self.assertAlmostEqual(
            results.loc[f"{ood_ds_name} LaRED"]["aupr"], 0.9419655799865723, delta=TOL
        )
        self.assertAlmostEqual(
            results.loc[f"{ood_ds_name} LaRED"]["fpr@95"], 0.2759999930858612, delta=TOL
        )
        self.assertAlmostEqual(
            results.loc[f"{ood_ds_name} LaREM"]["auroc"], 0.9485160112380981, delta=TOL
        )
        self.assertAlmostEqual(
            results.loc[f"{ood_ds_name} LaREM"]["aupr"], 0.9480809569358826, delta=TOL
        )
        self.assertAlmostEqual(
            results.loc[f"{ood_ds_name} LaREM"]["fpr@95"], 0.25600001215934753, delta=TOL
        )
