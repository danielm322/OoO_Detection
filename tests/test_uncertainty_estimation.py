    ...
    def test_get_dl_h_z(self):
        ...
        self.assertTrue(
            np.allclose(
                ...
                np.array(
                    [
                        0.66213845, -1.24553263, 0.43274342, 0.16964551, -0.11109334,
                        -0.15076459, 0.50606536, -0.938645, 0.4492352, 0.1962833,
                        0.7151791, 0.70086446, -0.89067232, 0.01402643, 0.96637271,
                        0.6283722, 0.34451879, -0.00393629, -0.48039907, 0.2459123
                    ]
                ),
            )
        )
            ...
            (
                ...
                - torch.Tensor(
                    [
                        ...
                        2.3841857910e-07, 0.0000000000e+00, 0.0000000000e+00,
                        0.0000000000e+00, 2.3841857910e-07, 0.0000000000e+00,
    ...
    def test_get_pred_uncertainty_score(self):
        ...
        self.assertTrue(
            (
                ...
                - torch.Tensor(
                    [
                        2.2954239845, 2.2936100960, 2.2913274765, 2.2875323296, 2.2929368019,
                        2.2918679714, 2.2960093021, 2.2968566418, 2.2959966660, 2.2814788818,
                        2.2842481136, 2.2999031544, 2.2889721394, 2.2876074314, 2.2898373604,
                        2.2722413540, 2.2952365875, 2.2890031338, 2.2956945896, 2.2963838577
                    ]
                )
            ).sum()
            < TOL
        ...
        self.assertTrue(
            (
                ...
                - torch.Tensor(
                    [
                        0.0174179077, 0.0362265110, 0.0232129097, 0.0191953182, 0.0291962624,
                        0.0250487328, 0.0286319256, 0.0462374687, 0.0337688923, 0.0085363388,
                        0.0118212700, 0.0289292336, 0.0174930096, 0.0185499191, 0.0275359154,
                        0.0115809441, 0.0252931118, 0.0210585594, 0.0264883041, 0.0213701725
                    ]
                )
            ).sum()
            < TOL
    ...
    def test_get_msp_score(self):
        ...
        self.assertTrue(
            np.allclose(
                ...
                np.array(
                    [
                        0.14480726, 0.13710754, 0.13400422, 0.14451809, 0.13787547,
                        0.13306601, 0.14861068, 0.14621589, 0.14574473, 0.13511162,
                        0.13810264, 0.14093828, 0.1471938, 0.144996, 0.14435232,
                        0.14504616, 0.14830166, 0.13930918, 0.14155908, 0.14461976
                    ]
                )
            )
        )
            ...
            np.allclose(
                ...
                np.array(
                    [
                        ...
                        1.1920929e-07, 0.0000000e+00, -1.1920929e-07, 1.1920929e-07,
                        1.1920929e-07, 0.0000000e+00, 0.0000000e+00, 0.0000000e+00,
    ...
    def test_MDSPostprocessor(self):
        ...
        self.assertTrue(
            (
                ...
                - torch.Tensor(
                    [
                        165.2596282959, -12.5079212189, 8.9375352859, -3.4928135872,
                        6.0702023506, -17.6381549835, -1.1519905329, 14.5131769180,
                        -36.5683860779, 30.9377803802, -5.0159239769, 30.1570549011,
                        -9.7787103653, 11.7463140488, -5.8539495468, -2.8339817524,
                        -1.1148993969, -21.3802356720, -43.9337997437, -15.5770769119
                    ]
                )
            ).sum()
            < TOL
        ...
        self.assertTrue(
            (
                ...
                - torch.Tensor(
                    [
                        0.5837824345, 0.0068388470, 0.2311379015, 0.3187698424,
                        0.2801628113, 0.0079951715, 0.0159174353, -0.5741344094,
                        0.1619823128, -0.6143783927, 0.2275377214, -0.2329114527,
                        -0.0491828360, 0.1668033451, 0.0840948597, 0.0450854897,
                        0.0546373986, 0.0204664711, -0.3509032130, 0.0088814823
                    ]
                )
            ).sum()
            < TOL
    ...
    def test_kNNPostprocessor(self):
        ...
        self.assertTrue(
            (
                ...
                - np.array(
                    [
                        0.35141832, 0.08980233, 0.03794549, 0.11652409, 0.12736143,
                        0.06724516, 0.02734577, -0.18319036, 0.01246245, -0.39833596,
                        0.14618297, -0.0928729, 0.03393501, 0.12940583, 0.15052024,
                        0.13174318, 0.08799291, 0.14757843, -0.08823613, 0.10692727
                    ]
                )
            ).sum()
            < TOL
        ...
        self.assertTrue(
            (
                ...
                - np.array(
                    [
                        -0.22327094, -0.15341546, -0.24850407, -0.21372338, -0.15940219,
                        -0.18464218, -0.14856, -0.18642662, -0.17184329, -0.1617361,
                        -0.15050437, -0.15412888, -0.23904872, -0.20866983, -0.2049842,
                        -0.19164929, -0.19247529, -0.14494337, -0.3010658, -0.27074164
                    ]
                )
            ).sum()
            < TOL
    ...
    def test_larem_postprocessor(self):
        ...
        self.assertTrue(
            np.allclose(
                ...
                np.array(
                    [
                        12.61048445, -0.75305318, -0.50165124, -0.11791143, -0.11522137,
                        0.01881437, -0.67406623, 0.4608969, -0.46416246, -0.02338144,
                        0.1637525, -0.27044667, -0.56074832, 0.1450181, 0.25837548,
                        0.84070141, 0.6010112, -0.15461955, -0.34001486, 0.24692961
                    ]
                )
            )
        )
        ...
        self.assertTrue(
            np.allclose(
                ...
                np.array(
                    [
                        -18.57565347, -25.08741653, -19.42807739, -20.54087356,
                        -20.43976452, -26.15764235, -25.1002785, -26.32450315,
                        -16.85869173, -26.99430034, -24.48394177, -16.25644187,
                        -20.19520139, -12.63947527, -17.54776882, -17.30209618,
                        -15.89407861, -20.50299392, -24.93608634, -16.28581699
                    ]
                )
            )
        )
